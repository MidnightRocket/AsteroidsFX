package dk.sdu.mmmi.cbse.common.vector;
...
public class BasicVector implements IVector, Cloneable {
	...
	public BasicVector setX(final double x) {
		this.x = x;
		return this;
	}
	...
	public BasicVector setY(final double y) {
		this.y = y;
		return this;
	}
	 ...
	 * @return The current instance. Allowing chaining method calls.
	 */
	public BasicVector scale(final double factor) {
		this.x *= factor;
		this.y *= factor;
		return this;
	}
	 ...
	 */
	public BasicVector add(final IVector vector) {
		this.x += vector.getX();
		this.y += vector.getY();
		return this;
	}
	 ...
	 */
	public BasicVector subtract(final IVector vector) {
